 ...
 * (Alternatively, remove this and add an `index.html` file in your * `assets`
 * directory) * *
 ******************************************************************************/
 ...
 ******************************************************************************/
  ...
  '/controlableunit/subscribe' : 'ControlableUnitController.subscribe',
  'GET /controlableunit/subscribe' : 'ControlableUnitController.subscribe',
  'PUT /controlableunit/subscribe' : 'ControlableUnitController.subscribe',
  'POST /controlableunit/subscribe' : 'ControlableUnitController.subscribe',
  'DELETE /controlableunit/subscribe' : 'ControlableUnitController.subscribe',

  'GET /controlableunit/unsubscribe' : 'ControlableUnitController.unsubscribe',
};
